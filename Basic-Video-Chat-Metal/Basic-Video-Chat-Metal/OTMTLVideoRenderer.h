 ...
 */
- (void)drawFrame:(otc_video_frame * _Nonnull)frame viewSize:(CGSize)viewSize;
/**
...
#else
- (BOOL)addRenderingDestination:(__kindof NSView *_Nullable)view;
#endif
@end
/**
...
@interface OTMTLVideoRenderer : NSObject<RTCMTLRenderer>
{
...
- (NSString *_Nullable)shaderSource;
- (BOOL)setupTexturesForFrame:(nonnull otc_video_frame *)frame viewSize:(CGSize)viewSize;
- (void)uploadTexturesToRenderEncoder:(id<MTLRenderCommandEncoder>_Nullable)renderEncoder;
