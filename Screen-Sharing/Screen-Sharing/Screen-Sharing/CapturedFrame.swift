...
class CaptureEngine: NSObject, @unchecked Sendable {
    ...
    func startCapture(configuration: SCStreamConfiguration, filter: SCContentFilter) -> AsyncThrowingStream<CapturedFrame, Error> {
        AsyncThrowingStream<CapturedFrame, Error> { continuation in
            ...
            streamOutput.otController = self.otController
...
private class CaptureEngineStreamOutput: NSObject, SCStreamOutput, SCStreamDelegate {
    ...
    func stream(_ stream: SCStream, didOutputSampleBuffer sampleBuffer: CMSampleBuffer, of outputType: SCStreamOutputType) {
        ...
        case .screen:
            ...
            if let otController = otController, otController.shouldProvideCustomCapturedFrame {
                otController.consumeBuffer(sampleBuffer)
            }
